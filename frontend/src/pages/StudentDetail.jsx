...
const StudentDetail = () => {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-2">Email: <span className="font-mono">{student.email}</span></div>
      <div className="mb-2">Year of Study: {student.yearOfStudy}</div>
      <div className="mb-2">Batch: {student.batch}</div>
      <div className="mb-2">CGPA: {student.cgpa}</div>
              ...
              <ul className="list-disc ml-6">
                {items.map((a) => (
                  <li key={a._id} className="mb-2">
                    ...
                    <div className="text-sm text-gray-500">{a.shortDescription}</div>
                    {a.file && (
                      <a
                        href={`http://localhost:5000/file/${a._id}`}
                        target="_blank"
